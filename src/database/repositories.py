...
class BaseRepository(Generic[ModelType]):
    ...
    async def get_all(
        ...
        try:
            ...
            raise DatabaseError(
                message=f"Failed to get {self.model.__name__} records",
                details={"error": str(e)}
            )
    ...
    async def bulk_update(
        ...
        try:
            ...
            raise DatabaseError(
                message=f"Failed to bulk update {self.model.__name__}",
                details={"error": str(e)}
            )
    ...
    async def bulk_delete(
        ...
        try:
            ...
            raise DatabaseError(
                message=f"Failed to bulk delete {self.model.__name__}",
                details={"error": str(e)}
            )
    ...
    async def search(
        ...
        try:
            ...
            logger.error(
                f"Failed to search {self.model.__name__}",
                error=e
            )
            raise DatabaseError(
...
class LocationRepository(BaseRepository[Location]):
    ...
    async def get_by_type(
        ...
        try:
            ...
            raise DatabaseError(
                message="Failed to get locations",
                details={"type": location_type, "error": str(e)}
            )
