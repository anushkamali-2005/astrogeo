...
class FileUploadService:
    ...
    def __init__(self):
        ...
        logger.info("File upload service initialized", extra={"bucket": self.bucket_name})
    ...
    async def upload_file(
        ...
        try:
            ...
            upload_metadata.update({"original_filename": path.name, "file_size": str(file_size)})

            # Upload to S3
            extra_args = {"ContentType": content_type, "Metadata": upload_metadata}
            ...
            logger.info(
                ...
                extra={"filename": filename, "s3_key": s3_key, "size": file_size},
            )
