...
class InvalidCredentialsError(AuthenticationError):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None):
        super().__init__(message="Invalid credentials provided", details=details)
...
class TokenExpiredError(AuthenticationError):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None):
        super().__init__(message="Access token has expired", details=details)
...
class InvalidTokenError(AuthenticationError):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None):
        super().__init__(message="Invalid or malformed token", details=details)
...
class InvalidAPIKeyError(AuthenticationError):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None):
        super().__init__(message="Invalid API key", details=details)
...
class RecordNotFoundError(DatabaseError):
    ...
    def __init__(self, resource: str, resource_id: Any, details: Optional[Dict[str, Any]] = None):
        details = details or {}
        details.update({"resource": resource, "resource_id": str(resource_id)})
        super().__init__(message=f"{resource} with ID {resource_id} not found", details=details)
...
class DuplicateRecordError(DatabaseError):
    ...
    def __init__(self, resource: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=f"{resource} already exists", details=details)
...
class DatabaseConnectionError(DatabaseError):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None):
        super().__init__(message="Failed to connect to database", details=details)
...
class InvalidInputError(ValidationError):
    ...
    def __init__(self, field: str, reason: str, details: Optional[Dict[str, Any]] = None):
        ...
        super().__init__(message=f"Invalid input for field '{field}': {reason}", details=details)
...
class MissingFieldError(ValidationError):
    ...
    def __init__(self, field: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=f"Required field '{field}' is missing", details=details)
...
class ModelError(BaseAPIException):
    ...
    def __init__(
        self, message: str = "Model operation failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
            message=message,
            error_code="ML_001",
...
class ModelNotFoundError(ModelError):
    ...
    def __init__(self, model_name: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=f"Model '{model_name}' not found", details=details)
...
class ModelLoadError(ModelError):
    ...
    def __init__(self, model_name: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=f"Failed to load model '{model_name}'", details=details)
...
class PredictionError(ModelError):
    ...
    def __init__(
        self, message: str = "Model prediction failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message=message, details=details)
...
class ModelTrainingError(ModelError):
    ...
    def __init__(
        self, message: str = "Model training failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message=message, details=details)
...
class FeatureEngineeringError(ModelError):
    ...
    def __init__(
        self, message: str = "Feature engineering failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message=message, details=details)
...
class AgentError(BaseAPIException):
    ...
    def __init__(
        self, message: str = "Agent operation failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
            message=message,
...
class AgentExecutionError(AgentError):
    ...
    def __init__(self, agent_name: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=f"Agent '{agent_name}' execution failed", details=details)
...
class AgentTimeoutError(AgentError):
    ...
    def __init__(self, agent_name: str, timeout: int, details: Optional[Dict[str, Any]] = None):
        details = details or {}
        details["timeout_seconds"] = timeout
        super().__init__(
            message=f"Agent '{agent_name}' execution timed out after {timeout}s", details=details
        )
...
class DataProcessingError(BaseAPIException):
    ...
    def __init__(
        self, message: str = "Data processing failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
            message=message,
            error_code="DATA_001",
...
class DataIngestionError(DataProcessingError):
    ...
    def __init__(
        self, message: str = "Data ingestion failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message=message, details=details)
...
class DataValidationError(DataProcessingError):
    ...
    def __init__(
        self, message: str = "Data validation failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message=message, details=details)
...
class MLflowError(ExternalServiceError):
    ...
    def __init__(
        self, message: str = "MLflow operation failed", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(service_name="MLflow", message=message, details=details)
