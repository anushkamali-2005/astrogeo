...
from src.core.security import JWTManager, RateLimiter, hash_password, verify_password
...
class TestJWTManager:
    ...
    def test_verify_expired_token(self):
        ...
        token = JWTManager.create_access_token(data, expires_delta=timedelta(seconds=-1))
